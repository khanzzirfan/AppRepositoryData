...
BEGIN
   ...
   (      base_order_id		       NUMERIC(18)  IDENTITY PRIMARY KEY CLUSTERED,
          customer_id				   VARCHAR(100) COLLATE DATABASE_DEFAULT NULL,
		  order_id					   int,
		  order_placed				   VARCHAR(1)   COLLATE DATABASE_DEFAULT NULL,
		  order_date				   DATETIME,
