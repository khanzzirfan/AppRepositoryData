...
BEGIN
   ...
   (      id					NUMERIC(18)  IDENTITY PRIMARY KEY CLUSTERED,
          user_name				VARCHAR(100) COLLATE DATABASE_DEFAULT NULL,
		  user_role				VARCHAR(100) COLLATE DATABASE_DEFAULT NULL,
		  password_hash			NVARCHAR(MAX) 				COLLATE DATABASE_DEFAULT NULL,
		  password_version		NVARCHAR(MAX) 				COLLATE DATABASE_DEFAULT NULL,
		  reset_key				uniqueidentifier,
...
PasswordVersion	uniqueidentifier	no	16
ResetKey	uniqueidentifier	no	16
IsDeleted	bit	no	1
