...
BEGIN
   ...
   (      customer_id             NUMERIC(18)  IDENTITY PRIMARY KEY CLUSTERED,
          first_name	          VARCHAR(100) COLLATE DATABASE_DEFAULT NOT NULL,
          last_name		          VARCHAR(100)   NOT NULL,
          full_name               VARCHAR(100) COLLATE DATABASE_DEFAULT NOT NULL,
		  dob					  DATETIME,
		  ird_number			  VARCHAR(100) COLLATE DATABASE_DEFAULT NULL,
          gender				  VARCHAR(10)  COLLATE DATABASE_DEFAULT NULL,
		  email					  VARCHAR(100) COLLATE DATABASE_DEFAULT NULL,
		  phone_number			  VARCHAR(100) COLLATE DATABASE_DEFAULT NULL,
		  home_number			  VARCHAR(100) COLLATE DATABASE_DEFAULT NULL,
		  address_id			  NUMERIC(18),
		  
		  ----AUDIT COlumns Leave as is.
