...
BEGIN
   ...
   (      address_id             NUMERIC(18)  IDENTITY PRIMARY KEY CLUSTERED,
          steet_line1            VARCHAR(100) COLLATE DATABASE_DEFAULT NULL,
          steet_line2            VARCHAR(100) COLLATE DATABASE_DEFAULT NULL,
		  region				 VARCHAR(100) COLLATE DATABASE_DEFAULT NULL,
		  city					 VARCHAR(100) COLLATE DATABASE_DEFAULT NULL,
		  post_code				 NUMERIC(18),
		  [state]				 VARCHAR(100) COLLATE DATABASE_DEFAULT NULL,
		  country_id			 NUMERIC(18),
