...
IF NOT EXISTS(SELECT *
                FROM sys.objects
               WHERE TYPE = 'U'
                 AND NAME = 'price_plan_rates')
BEGIN
   -- Define your columns in your table
   CREATE TABLE dbo.[price_plan_rates]
   (      price_plan_rate_id   NUMERIC(18)  IDENTITY PRIMARY KEY CLUSTERED,
		  ...
		  concession_flag	   VARCHAR(100) COLLATE DATABASE_DEFAULT NULL,
