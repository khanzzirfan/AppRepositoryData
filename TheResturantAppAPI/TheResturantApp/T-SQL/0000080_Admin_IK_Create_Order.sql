...
BEGIN
   ...
   (      order_id				NUMERIC(18)  IDENTITY PRIMARY KEY CLUSTERED,
          order_name			VARCHAR(100) COLLATE DATABASE_DEFAULT NOT NULL,
		  customer_id			NUMERIC(18),
		  employee_id			NUMERIC(18),
		  order_date			DATETIME,
		  required_date			DATETIME	NULL,
		  order_complete		DATETIME	NULL,
		  total_amount			MONEY,
		  tax_amount			MONEY,
		  discount				MONEY,
		  comments				VARCHAR(500)  COLLATE DATABASE_DEFAULT NOT NULL,
