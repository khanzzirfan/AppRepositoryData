...
BEGIN
   ...
   (      menu_id		       NUMERIC(18)  IDENTITY PRIMARY KEY CLUSTERED,
          menu_name 		   VARCHAR(100) COLLATE DATABASE_DEFAULT NULL,
		  menu_description	   VARCHAR(1000) COLLATE DATABASE_DEFAULT NULL,
		  menu_type_id		   NUMERIC(18),
		  menu_category_id	   NUMERIC(18),
		  menu_price		   MONEY,
