...
BEGIN
   ...
   (      employee_id	       NUMERIC(18)  IDENTITY PRIMARY KEY CLUSTERED,
          first_name		   VARCHAR(100) COLLATE DATABASE_DEFAULT NULL,
		  last_name			   VARCHAR(100) COLLATE DATABASE_DEFAULT NULL,
